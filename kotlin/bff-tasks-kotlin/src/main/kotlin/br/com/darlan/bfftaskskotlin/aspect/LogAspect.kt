package br.com.darlan.bfftaskskotlin.aspect
...
class LogAspect {
    ...
    @Around("@annotation(br.com.darlan.bfftaskskotlin.aspect.annotations.LogExecution)")
    fun logExecutionTime(joinPoint: ProceedingJoinPoint): Any {
        val start = System.currentTimeMillis()
        val signature = joinPoint.signature.toShortString()
        val result = try {
            with(StringBuilder("Starting -> Executing $signature, ")) {
        ...
        logger.info("Ending -> Finished executing: $signature, returned: '$result', duration: $duration ms")
        return result
    }
